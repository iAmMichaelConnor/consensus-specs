...
gen_kzg_setups:
	...
	. venv/bin/activate; \
	pip3 install -r requirements.txt; \
	python3 ./gen_kzg_trusted_setups.py --secret=1337 --g1-length=8 --g2-length=65 --output-dir ${CURRENT_DIR}/presets/minimal/trusted_setups; \
	python3 ./gen_kzg_trusted_setups.py --secret=1337 --g1-length=8 --g2-length=65 --output-dir ${CURRENT_DIR}/presets/mainnet/trusted_setups
